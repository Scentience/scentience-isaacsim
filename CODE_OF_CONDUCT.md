...
reported to the maintainers through GitHub (an issue for public matters, or
the repository's private vulnerability-reporting channel if the report itself
...
temporarily or permanently removed from the project team.

## Attribution

Adapted from the [Contributor Covenant](https://www.contributor-covenant.org),
version 2.1. For the full text including the enforcement-guidelines ladder,
see the link above.
