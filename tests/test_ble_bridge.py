...
from scentience_olfaction.sensors.mox import MOX_RED


def test_inversion_roundtrip():
    A, beta = MOX_RED.sensitivity["ethanol"]
    c = 50.0
    ratio = A * c ** (-beta)
...
def test_frame_schema_and_zero_omission():
    reading = {"chem_left_red": 1.0, "chem_left_nh3": 1.0, "chem_left_ox": 1.0,
               "chem_right_red": 1.0, "chem_right_nh3": 1.0, "chem_right_ox": 1.0,
    ...
    reading["chem_left_red"] = 0.2                       # strong ethanol response
